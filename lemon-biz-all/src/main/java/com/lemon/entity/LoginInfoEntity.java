...
public class LoginInfoEntity {
	...
	public boolean equals(Object o) {
		...
		return loginId == that.loginId && createId == that.createId && updateId == that.updateId
				...
				&& Objects.equals(loginNameUpdateTimes, that.loginNameUpdateTimes) && Objects.equals(email, that.email)
				&& Objects.equals(emailStatus, that.emailStatus) && Objects.equals(mobile, that.mobile)
				&& Objects.equals(mobileStatus, that.mobileStatus) && Objects.equals(registerTime, that.registerTime)
				&& Objects.equals(inviteCode, that.inviteCode) && Objects.equals(auditStatus, that.auditStatus)
				&& Objects.equals(auditRemark, that.auditRemark) && Objects.equals(createTime, that.createTime)
	...
	public int hashCode() {
		return Objects.hash(loginId, loginName, loginPwd, loginNameUpdateTimes, email, emailStatus, mobile,
				mobileStatus, registerTime, inviteCode, auditStatus, auditRemark, createId, createTime, updateId,
				updateTime);
	}
}
