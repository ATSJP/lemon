nohup java -jar lemon-config-0.0.1-SNAPSHOT.jar --spring.cloud.config.profile=prod > log/config.log 2>&1 &
nohup java -jar eureka-server-0.0.1-SNAPSHOT.jar --spring.cloud.config.profile=prod > log/server.log 2>&1 &
